...
def test_nextqa_joint_av_npu_launcher_wires_video_gspo_training():
    launcher_dir = Path(__file__).parents[2] / "examples/gspo_trainer/qwen3_omni"
    launcher = (launcher_dir / "run_qwen3_omni_thinker_gspo_npu_nextqa_joint_av_v1.sh").read_text(encoding="utf-8")
...
def test_nextqa_joint_av_lora_npu_launcher_combines_lora_training_with_npu_runtime():
    launcher_dir = Path(__file__).parents[2] / "examples/gspo_trainer/qwen3_omni"
    launcher = (launcher_dir / "run_qwen3_omni_thinker_gspo_lora_nextqa_joint_av_v1_npu.sh").read_text(encoding="utf-8")
