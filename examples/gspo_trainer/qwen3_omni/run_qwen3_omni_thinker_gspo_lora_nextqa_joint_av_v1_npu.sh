#!/usr/bin/env bash
# Qwen3-Omni Thinker GSPO + LoRA training on NextQA with the omni V1 trainer.
# Joint AV recipe; see README_nextqa_joint_av.md for the required verl revision.
...
python3 -m verl_omni.trainer.main_omni \
    ...
    trainer.experiment_name=gspo_lora_nextqa_joint_av_npu \
